...
sel=$(echo "$list_num" | rofi -dmenu -columns 1 -format i -fake-transparency -p '/music ' -selected-row $prev -scroll-method 1 -i -theme-str 'listview{margin:0 calc(100%- 500px) 0 72px;}')
